...
INSERT INTO Classroom (building_name, room_number, seats) VALUES("Thornton", "325", 50);
...
WHERE s.name = 'CSC'; 
INSERT INTO Class (name, number, credit_hours, subject_id)
SELECT "Intermediate Computer Programming", 
"215", 3.0, s.subject_id
FROM Subject s
WHERE s.name = 'CSC'; 
INSERT INTO Class (name, number, credit_hours, subject_id)
...
INSERT INTO Class_Section (name, days, start_time, end_time, 
	class_id, classroom_id, semester_id)
SELECT 
	"CSC 215 Section 01", "M,W", "12:00", "1:15",
	(SELECT c.class_id FROM Class c JOIN Subject s ON c.subject_id = s.subject_id 
	WHERE c.number = '215' AND s.name = "CSC") AS classid,
    (SELECT classroom_id FROM Classroom 
    WHERE building_name = 'Thornton' 
	AND room_number = '325') AS classroomid,
    (SELECT semester_id FROM Semester 
    WHERE year = 2024 
	AND season = 'Spring') AS semesterid;
-- PHYS 220 01
...
INSERT INTO Module (name, description, class_section_id)
SELECT
	'CSC 317 Module 2', 'More documents and assignments for CSC 317', 
    cs.class_section_id
FROM
	Class_Section cs
JOIN
...
INSERT INTO Module (name, description, class_section_id)
SELECT
	'CSC 317 Module 3', 'Documents and assignments for CSC 317 Section 2', 
    cs.class_section_id
FROM
	Class_Section cs
JOIN
...
JOIN
	Subject s ON c.subject_id = s.subject_id
WHERE
	cs.name = 'CSC 317 Section 02'; 
INSERT INTO Module (name, description, class_section_id)
SELECT
	'CSC 317 Module 4', 'More documents and assignments for CSC 317 Section 2', 
    cs.class_section_id
FROM
	Class_Section cs
JOIN
...
INSERT INTO Module (name, description, class_section_id)
SELECT
	'CSC 340 Module 1', 'Documents and assignments for CSC 340 Section 1', 
    cs.class_section_id
FROM
	Class_Section cs
JOIN
...
JOIN
	Subject s ON c.subject_id = s.subject_id
WHERE
	cs.name = 'CSC 340 Section 01';  
INSERT INTO Module (name, description, class_section_id)
SELECT
	'CSC 215 Module 1', 'Documents and assignments for CSC 215 Section 1', 
    cs.class_section_id
FROM
	Class_Section cs
JOIN
...
INSERT INTO Module (name, description, class_section_id)
SELECT
	'PHYS 222 Module 1', 'Documents and assignments for PHYS 222 Section 1', 
    cs.class_section_id
FROM
	Class_Section cs
JOIN
...
INSERT INTO Document (name, description, link, module_id)
SELECT
	'CSC 340 Document 1', 'A class document for CSC 340', 'CSC317filename.pdf',
    m.module_id
FROM
	Module m
WHERE
	m.name = 'CSC 340 Module 1';
INSERT INTO Document (name, description, link, module_id)
SELECT
...
INSERT INTO Assignment (name, description, link, top_score, module_id)
SELECT
	'CSC 340 Assignment 1', 'A class assignment for CSC 317', 'CSC317filename.pdf',
    100, m.module_id
FROM
	Module m
WHERE
...
FROM Major m
CROSS JOIN Class c
WHERE m.name = "Computer Science" AND c.name = "Programming Methodology";
INSERT INTO `Major_Requirement` (major_id, class_id)
SELECT m.major_id, c.class_id
FROM Major m
CROSS JOIN Class c
WHERE m.name = "Computer Science" AND c.name = "Intermediate Computer Programming";
INSERT INTO `Major_Requirement` (major_id, class_id)
SELECT m.major_id, c.class_id
FROM Major m
CROSS JOIN Class c
...
SELECT s.student_id, a.assignment_id, "assignment.pdf"
FROM Student s
...
FROM Student s
CROSS JOIN Assignment a
WHERE s.username = "jsmith1" AND a.name = "CSC 340 Assignment 1";
INSERT INTO `Student-Completed-Assignment` (student_id, assignment_id, submittal_link)
SELECT s.student_id, a.assignment_id, "assignment.pdf"
FROM Student s
CROSS JOIN Assignment a
WHERE s.username = "skelvert" AND a.name = "CSC 340 Assignment 1";
INSERT INTO `Student-Completed-Assignment` (student_id, assignment_id, submittal_link)
SELECT s.student_id, a.assignment_id, "assignment.pdf"
FROM Student s
CROSS JOIN Assignment a
